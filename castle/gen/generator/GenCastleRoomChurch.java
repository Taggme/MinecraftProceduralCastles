...
public class GenCastleRoomChurch extends CastleChunk {

	public GenCastleRoomChurch(World world_, Random rand_, int XCoord_,
	...
	public void Generate(){
		...
		case CastleGen.RoomSouth:
			...
			ZCoord2 += CastleGen.RoomWidth / 2;
			XCoord3 += CastleGen.RoomWidth - 4;
			ZCoord3 += CastleGen.RoomWidth / 2 - 1;
			break;
		case CastleGen.RoomWest:
			ZCoord2 += CastleGen.RoomWidth - 4;
			XCoord2 += CastleGen.RoomWidth / 2;
			ZCoord3 += CastleGen.RoomWidth - 4;
			XCoord3 += CastleGen.RoomWidth / 2 - 1;
			break;
		}
		...
		world.setBlock(XCoord2, YCoord, ZCoord2, Blocks.planks, 1, 0);
		world.setBlock(XCoord2, YCoord + 1, ZCoord2, Blocks.torch);
		world.setBlock(XCoord3, YCoord, ZCoord3, Blocks.planks, 1, 0);
		world.setBlock(XCoord3, YCoord + 1, ZCoord3, Blocks.skull);
	}
    public void Window(){
    	CastleGen.GenCastleStainWindows(world, rand, XCoord, YCoord, ZCoord);
    }
